...
**前置条件：** 
- 合约未初始化
- 准备好金库地址、管理员地址和 chain id

**测试步骤：**
1. 调用 `initialize()` 方法，传入有效参数
2. 验证初始化结果

**预期结果：**
- 合约初始化成功
- 金库地址、管理员地址、chain id 被正确设置
- 初始 nonce 为 0
